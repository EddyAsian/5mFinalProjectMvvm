...
class AuthorizedProfileVC: UIViewController {
    ...
    lazy var profileTitle: UILabel = {
        ...
        title.font = UIFont(name: "Avenir Heavy", size: 22)
    ...
    private func setUpConstraints() {
        ...
        saveChanges.snp.makeConstraints { maker in
            maker.top.equalTo(passwordLabel.snp.bottom).inset(-20)
            maker.centerX.equalToSuperview()
...
//        dismiss(animated: false)
    ...
    private func showAlert() {
        let alert = UIAlertController(
            title: "Этого недостаточно",
            message: "Для регистрации нужно заполнить все три пункта",
